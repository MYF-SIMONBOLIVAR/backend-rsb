...
const db = mysql.createPool({
    host: '193.203.175.239', // Usamos la IP directamente aquí para descartar fallos de variables
    ...
    // Forzamos a que use IPv4 y configuramos el SSL de forma compatible
    ssl: {
